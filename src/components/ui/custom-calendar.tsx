...
export function CustomCalendar({
  ...
  // Don't render calendar content until client-side
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {/* Calendar Popup */}
      {isOpen && (
        <div className="absolute top-full left-0 z-50 mt-2 w-80 rounded-lg border bg-card shadow-2xl animate-in fade-in-0 zoom-in-95">
          {/* Calendar Header */}
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isTodayDate &&
                        !isSelected &&
                        "bg-accent font-bold border border-primary"
                    )}
                  >
                    {format(date, "d")}
                  </button>
